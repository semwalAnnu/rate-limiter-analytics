...
```json
{
  ...
  "method": "GET",
  "status": "allowed", // "allowed" | "rejected" | "circuit_open"
  "latency_ms": 12.4,
  "tokens_remaining": 87.0,
  "upstream_status": 200 // null if rejected before forwarding
}
```
...
Phase 2 — Analytics pipeline (Week 2)
...
Phase 3 — Polish + benchmarks (Week 3)
